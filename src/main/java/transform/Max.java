...
//TODO max :除了比较的值,其他的属性与第一条数据一样    maxBy : 除了比较的值,其他的值也会跟着变
public class Max {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<SensorReading> max = sensor.max("v");
        max.print();
        env.execute();
        ...
        //SensorReading(sensor=sensor_2, l=1234567890, v=32.5)
        //SensorReading(sensor=sensor_1, l=1234567981, v=33.5)
        //SensorReading(sensor=sensor_3, l=1234568911, v=31.5)
    }
}
