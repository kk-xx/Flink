...
public class TimeSliding {
    public static void main(String[] args) throws Exception {
        ...
        //设置划动窗口,窗口大小为5秒,滑动步长为2秒
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> tumblingWindow = keyDS.timeWindow(Time.seconds(5),Time.seconds(2));
        //窗口内聚合
